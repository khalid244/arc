...
// Tier identifies a precalc bucket size. The system stores only 1h
// rollups now; the type is kept so existing signatures continue to type-check.
type Tier string
...
// DateTruncArg returns "hour" for Tier1h, "" otherwise.
